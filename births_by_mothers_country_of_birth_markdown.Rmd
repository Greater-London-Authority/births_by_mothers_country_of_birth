...
The data also shows that London accounted for `r top_region_ew_total_births_overseas_mothers_perc` of all the births to non-UK-born mothers in England and Wales in `r latest_year`, which was a far higher proportion than any other region.
...
maps_list<-map(as.list(list.files("figures/maps", full.names=TRUE, pattern = paste0("_", latest_year, ".jpeg"))), ~image_read(.x))
